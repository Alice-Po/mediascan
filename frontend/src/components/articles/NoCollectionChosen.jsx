  ...
  return (
    <div className="text-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto">
        ...
        <h3 className="mt-2 text-lg font-medium text-gray-900">Commencez votre veille</h3>
        <p className="mt-1 text-sm text-gray-500">
          Pour voir des articles, vous devez d'abord sélectionner une collection dans le menu
          latéral.
        </p>
        <div className="mt-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              Découvrir des collections publiques
            </Link>
          </div>
          <p className="text-xs text-gray-500 mt-4">
            Ou sélectionnez une collection existante dans le menu latéral
          </p>
        </div>
      </div>
    </div>
...
export default NoCollectionChosen;

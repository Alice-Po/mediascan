...
const UserAnalytics = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <PremiumBanner
        className="mb-8"
        title="Envie d'aller plus loin dans l'analyse de vos lectures ?"
        description="Nous réfléchissons à de nouvelles façons de vous aider à comprendre vos habitudes de lecture : temps passé par source, sujets récurrents, évolution de vos centres d'intérêt..."
        linkText="Contribuer à la réflexion sur les analytics"
      />

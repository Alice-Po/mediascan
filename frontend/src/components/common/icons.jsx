...
// Icône d'avertissement/information
...
// Icône étoile pour indiquer la collection par défaut
...
// Icône de coche/check pour le suivi de collections
...
// Icône pour ajouter des sources (+)
export const AddSourceIcon = ({ className }) => (
...
// Icône X pour supprimer des éléments (comme les sources dans une collection)
...
// Icône de flèche vers le bas pour l'indicateur de défilement
export const ChevronDownIcon = ({ className }) => (
  <svg
    className={className || 'w-8 h-8 animate-bounce'}
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
  >
...
// Icône groupe d'utilisateurs pour section principes fondamentaux
...
// Icône ampoule d'idée pour Transparence algorithmique
...
// Icône de foudre/éclair pour la transparence technique
...
// Icône balance pour l'indépendance
...
// Icône de cadenas pour le pluralisme intellectuel
export const ShieldLockIcon = ({ className }) => (
  <svg className={className || 'w-6 h-6'} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
// Icône de flèche vers la droite pour les CTA
